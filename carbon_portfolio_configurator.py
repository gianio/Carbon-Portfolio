...
# Create a single column with a large width ratio
wide_col, = st.columns(1) # Creates one column that takes up the full available width within the centered container
...
with wide_col:
    ...
    # --- For the rest use columns for layout ---
